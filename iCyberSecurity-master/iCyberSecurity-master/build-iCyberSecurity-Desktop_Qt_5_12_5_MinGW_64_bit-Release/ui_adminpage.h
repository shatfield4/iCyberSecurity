...
public:
    ...
    void retranslateUi(QDialog *AdminPage)
    {
        ...
        pushButton_2->setText(QApplication::translate("AdminPage", "Sort By Key", nullptr));
        loadCustomerData->setText(QApplication::translate("AdminPage", "Load Customer Data From File", nullptr));
        pushButton->setText(QApplication::translate("AdminPage", "Sort By Customer Name", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("AdminPage", "Customer Listing", nullptr));
        QTableWidgetItem *___qtablewidgetitem = pamphletTable->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("AdminPage", "Name", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = pamphletTable->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("AdminPage", "Email", nullptr));
        buttonLoadPamphlets->setText(QApplication::translate("AdminPage", "Load Pamphlet Submissions", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("AdminPage", "Pamphlet Requests", nullptr));
    } // retranslateUi
